...
class MainWindow(QMainWindow):
    ...
    def _customer_page(self):
        ...
        edit=QPushButton("Bewerken"); edit.clicked.connect(self.edit_customer); contacts=QPushButton("Contactpersonen"…4337 tokens truncated….refresh_all();self.mail_page.reload()
